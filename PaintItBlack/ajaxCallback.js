...
function serverGetJson(){
  let url = "http://30147.hosts2.ma-cloud.nl/bewijzenmap/leerjaar2/PaintItBlack/drawing.json"
  makeAjaxCall(url, "GET"). then (readJson, errorHandler);
}

function preload(){
  let url = "http://30147.hosts2.ma-cloud.nl/bewijzenmap/leerjaar2/PaintItBlack/preload.json"
